...
class Knop(): 
    ...
    def teken(self, screen): 
        ...
        if len(self.text) > 6: 
            screen.blit(font.render(self.text, True, (0,0,0)),dest=((self.positieX_knop + self.breedte // 2- 20)-20, self.positieY_knop + self.hoogte // 2-15))  #dest= locX, locY
        else: 
...
def keuze(screen):
    ...
    MID_knop = Knop(375,250,200,75, "GEMIDDELD")
