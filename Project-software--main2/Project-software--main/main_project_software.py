...
class Speler(Figuur): 
    ...
    def bewegingeself, maze, snelheid):  
        ...
        nieuwe_x = self.x + dx * 20
        nieuwe_y = self.y + dy * 20

    # Doolhof-offset: linksboven hoek van het doolhof op het scherm
        offset_x = 50
        offset_y = 15

        rij = (nieuwe_y - offset_y) // 20
        kolom = (nieuwe_x - offset_x) // 20
